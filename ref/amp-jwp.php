			...
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item active-item" href="amp-jwp.php"><i class="fa fa-angle-right"></i><em></em>AMP JWPlayer<i class="fa fa-circle"></i></a>
	...
	<div class="page-content">
		...
		<div class="tint-block tint-block-top bg-body-1">
			<div class="tint-content">
				...
				<h1 class="color-white uppercase">JWP Player</h1>
				<span>
		...
		<div class="content page-content-card page-content-card-bottom full-bottom">
		    ...
		    <amp-jwplayer data-media-id="BZ6tc0gy" data-player-id="uoIbMPm3" layout="responsive" width="16" height="9"></amp-jwplayer>
