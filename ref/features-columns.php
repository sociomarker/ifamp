			...
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item active-item" href="features-columns.php"><i class="fa fa-angle-right"></i><em></em>Columns<i class="fa fa-circle"></i></a>
	...
	<div class="page-content">
		...
		<div class="tint-block tint-block-top bg-body-1">
			<div class="tint-content">
				<h1 class="color-white uppercase">Columns</h1>
				<span>
					The backbone of any template, simple to use and fast loading.
				</span>
