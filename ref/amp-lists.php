...
<body class="dark-scheme">	
			...
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item  active-item" href="amp-list.php"><i class="fa fa-angle-right"></i><em></em>AMP List<i class="fa fa-circle"></i></a>
	...
	<div class="page-content">
		...
		<div class="tint-block tint-block-top bg-body-1 full-bottom">
		...
		<div class="content page-content-card full-bottom">
			<h4 class="icon-heading uppercase ultrabold half-bottom">Just lists! <i class="fa fa-bolt"></i></h4>
			<p>
