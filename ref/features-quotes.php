			...
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item active-item" href="features-quotes.php"><i class="fa fa-angle-right"></i><em></em>Quotes<i class="fa fa-circle"></i></a>
	...
	<div class="page-content">
		...
		<div class="tint-block tint-block-top bg-body-1">
			<div class="tint-content">
				<h1 class="color-white uppercase">Quotes</h1>
				<span>
		...
		<div class="content page-content-card page-content-card-bottom full-bottom">
			<div class="blockquote-4">
				...
				<p class="half-bottom">
					Great product as always plus good team and wonderful support. Worth 5 stars and more! Please keep up the good work.
				</p>
				<a href="#" class="right-text small-text full-bottom">Alexander Stranger</a>
			</div>			
			...
			<div class="blockquote-2 full-bottom">
				...
				<a href="#">Awesome Buyer | ThemeForest</a>
			</div>
			
			<div class="decoration"></div>
			
			<div class="blockquote-3 full-bottom">
				<amp-img class="blockquote-image" src="images/pictures/3t.jpg" width="150" height="150"></amp-img>
				...
				<a href="#" class="center-text small-text full-bottom">Awesome Buyer | ThemeForest</a>
			</div>				
		</div>		
