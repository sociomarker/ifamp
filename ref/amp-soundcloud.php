	...
	<header>
		...
		<div id="menu-sidebar" class="menu menu-sidebar">
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					<input type="checkbox" data-submenu-items="5" class="toggle-submenu" id="toggle-9" checked>
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item active-item" href="amp-soundcloud.php"><i class="fa fa-angle-right"></i><em></em>AMP SoundCloud<i class="fa fa-circle"></i></a>
	...
	<div class="page-content">
		...
		<div class="tint-block tint-block-top bg-body-1">
			<div class="tint-content">
				...
				<h1 class="color-white uppercase">Sound Cloud</h1>
				<span>
			...
			<div class="tint bg-teal-light"></div>
		</div>
		
		<div class="content page-content-card page-content-card-bottom full-bottom">
			<h4 class="icon-heading uppercase ultrabold half-bottom">Audio Embed <i class="fa fa-bolt"></i></h4>
			<p>
				Embed videos with captions, in full width or boxed, with or without the branding icon. It's super easy.
			</p>
			<amp-soundcloud class="full-bottom" height="166" layout="fixed-height" data-trackid="194181932" data-color="448AFF"></amp-soundcloud>	
			<div class="decoration"></div>
			<amp-soundcloud class="full-bottom" height="450" layout="fixed-height"  data-trackid="194181932" data-visual="true"></amp-soundcloud>	
			<a href="#" class="button-3d border-teal-dark bg-teal-light uppercase ultrabold button-full">Purchase Now</a>
