			...
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item active-item" href="features-dividers.php"><i class="fa fa-angle-right"></i><em></em>Dividers<i class="fa fa-circle"></i></a>
	...
	<div class="page-content">
		...
		<div class="tint-block tint-block-top bg-body-1">
			<div class="tint-content">
				<h1 class="color-white uppercase">Dividers</h1>
				<span>
			...
			<div class="tint bg-orange-light"></div>
		</div>
		
		<div class="content page-content-card page-content-card-bottom full-bottom">
			<h4 class="icon-heading uppercase ultrabold half-bottom">Page Decorations <i class="fa fa-star"></i></h4>
			<p>
				Add style to your separators, with simple copy and paste classes.
			</p>
			
			<div class="full-bottom"></div>
			<div class="deco bg-red-dark"></div>
			<div class="deco bg-blue-dark"></div>
			<div class="deco bg-green-dark"></div>
			<div class="deco bg-orange-dark"></div>
