...
<body class="dark-scheme bg-body">	
			...
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item active-item" href="cover-5.php"><i class="fa fa-angle-right"></i><em></em>Cover Style 5<i class="fa fa-circle"></i></a>
					</div>	
				</div>
				<div class="submenu-item">
	...
	<div class="cover-5">
		<h1>Hello!</h1>
		<em>We're Mobile Elite Author!</em>
		<p>
			We create amazing mobile websites!
			We're always available for you!
			Let's get in touch and we'll make your 
			mobile website absolutely awesome!
		</p>
		<a href="#" class="button button-center button-round bg-green-dark bold uppercase">Get in Touch</a>
