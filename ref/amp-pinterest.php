			...
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item active-item" href="amp-pinterest.php"><i class="fa fa-angle-right"></i><em></em>AMP Pinterest<i class="fa fa-circle"></i></a>
	...
	<div class="page-content">
		...
		<div class="tint-block tint-block-top-simple bg-body-1 full-bottom">
			<div class="tint-content">
				...
				<h1 class="color-white uppercase">Pinterest</h1>
				<span>
			...
			<div class="tint bg-red-dark"></div>
		</div>
		...
		<amp-pinterest class="full-bottom" width=320 height=280 layout="responsive" data-do="embedPin" data-url="https://www.pinterest.com/pin/427208714637069788/"></amp-pinterest>
		<div class="content">
			<div class="decoration"></div>
			<a href="#" class="button-3d border-red-dark bg-red-light uppercase ultrabold button-full">Purchase Now</a>
