			...
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item active-item" href="amp-twitter.php"><i class="fa fa-angle-right"></i><em></em>AMP Twitter<i class="fa fa-circle"></i></a>
	...
	<div class="page-content">
		...
		<div class="tint-block tint-block-top-simple bg-body-1 full-bottom">
			<div class="tint-content">
				...
				<h1 class="color-white uppercase">Twitter</h1>
				<span>
		...
		<div class="content">
			...
			<amp-twitter class="full-bottom" width="390" height="330" layout="responsive" data-tweetid="782938357659799552" data-cards="hidden"></amp-twitter>
		<div class="content">
