...
<body class="dark-scheme">	
			...
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item active-item" href="features-headings.php"><i class="fa fa-angle-right"></i><em></em>Headings<i class="fa fa-circle"></i></a>
					</div>	
				</div>
				<div class="submenu-item">
	...
	<div class="page-content">
		...
		<div class="heading-block bg-1">
			<h4 class="center-text">Large Heading Box</h4>
		...
		<div class="heading-block bg-2">
			<h4 class="center-text">With a Button</h4>
			<a href="#" class="button">Purchase</a>
			<div class="overlay"></div>
		</div>
