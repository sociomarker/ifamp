...
<body class="dark-scheme bg-body">	
	<header>
		...
		<div id="menu-sidebar" class="menu menu-sidebar">
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						<a class="menu-item active-item" href="cover-1.php"><i class="fa fa-angle-right"></i><em></em>Cover Style 1<i class="fa fa-circle"></i></a>
		...
		<div class="cover-1">
			<h1>Welcome</h1>
			<h6>Your awesome cover headline here.</h6>
			<p>
				Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
				Nam at dui ullamcorper, pharetra risus quis, rhoncus massa.
				Sed quis nunc sit amet mi facilisis sodales. Curabitur velit
				lacus, ultricies id neque in, imperdiet ultricies nunc. Donec
				vel malesuada dui. Mauris vulputate turpis et nunc suscipit
				blandit. 
			</p>
			<a href="#" class="button uppercase bold">GET A QUOTE</a>
			<a href="#" class="button uppercase bold">FREE TRIAL</a>
		</div>
