...
<body class="dark-scheme">	
			...
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item active-item" href="amp-notifications.php"><i class="fa fa-angle-right"></i><em></em>AMP User Notifications<i class="fa fa-circle"></i></a>
					</div>	
				</div>
	...
	<div class="page-content">
		...
		<div class="tint-block tint-block-top-simple bg-body-1 full-bottom">
			<div class="tint-content">
				<h1 class="color-white uppercase">AMP</h1>
				<h1 class="color-white uppercase">Notifications</h1>
				<span>
		...
		<div class="content page-content-card-simple full-bottom">
			<h4 class="icon-heading uppercase ultrabold half-bottom">Large User Alerts<i class="fa fa-bolt"></i></h4>
			<p>
		...
		<div class="notification bg-red-dark">
			<h4 class="color-white uppercase ultrabold">Warning!</h4>
			<p class="color-white no-bottom">
				This is a warning notification. You can add whatever text you want here.
			</p>
		</div>		
		
		<div class="notification bg-yellow-light">
			<h4 class="color-white uppercase ultrabold">Attention!</h4>
			<p class="color-white no-bottom">
				This is a attention notification. You can add whatever text you want here.
			</p>
		</div>
		
		<div class="notification bg-blue-dark">
			<h4 class="color-white uppercase ultrabold">Information</h4>
			<p class="color-white no-bottom">
				This is a information notification. You can add whatever text you want here.
			</p>
		</div>	
		
		<div class="notification bg-green-dark">
			<h4 class="color-white uppercase ultrabold">All good!</h4>
			<p class="color-white no-bottom">
				This is an all good notification. You can add whatever text you want here.
			</p>
		</div>
		...
		<div class="content page-content-card-simple full-bottom">
			<h4 class="icon-heading uppercase ultrabold half-bottom">Small User Alerts<i class="fa fa-bolt"></i></h4>
			<p>
				These are cookie consent or other conset notifications that are fixed to the bottom.
			</p>
		</div>
		...
		<div class="notification bg-red-dark">
			<h6 class="color-white uppercase bold">Warning!</h6>
		</div>		
		
		<div class="notification bg-yellow-light">
			<h6 class="color-white uppercase bold">Attention!</h6>
		</div>
		
		<div class="notification bg-blue-dark">
			<h6 class="color-white uppercase bold">Information</h6>
		</div>	
		
		<div class="notification bg-green-dark">
			<h6 class="color-white uppercase bold">All good!</h6>
		</div>
