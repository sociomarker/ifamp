			...
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item active-item" href="amp-social-share.php"><i class="fa fa-angle-right"></i><em></em>AMP Social Share<i class="fa fa-circle"></i></a>
					</div>	
				</div>
				<div class="submenu-item">
	...
	<div class="page-content">
		...
		<div class="tint-block tint-block-top-simple bg-body-1 full-bottom">
			<div class="tint-content">
				...
				<h1 class="color-white uppercase">Social Share</h1>
				<span>
		...
		<div class="content page-content-card full-bottom">
			<h4 class="icon-heading uppercase ultrabold half-bottom">Share Icons <i class="fa fa-bolt"></i></h4>
			<p>
				AMP Share icons do the share work for you. Just tap them and your link will automatically be prepared for sharing.
			</p>
			<amp-social-share type="twitter" width="40" height="40"> </amp-social-share>
			<amp-social-share type="facebook" width="40" height="40" data-param-app_id="254325784911610"></amp-social-share>
