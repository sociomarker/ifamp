		...
		<div id="menu-sidebar" class="menu menu-sidebar">
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					<input type="checkbox" data-submenu-items="4" class="toggle-submenu" id="toggle-1" checked>
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item active-item" href="index-login.php"><i class="fa fa-angle-right"></i><em></em>Login<i class="fa fa-circle"></i></a>
