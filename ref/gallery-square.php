...
<body class="dark-scheme">	
			...
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item active-item" href="gallery-square.php"><i class="fa fa-angle-right"></i><em></em>Square<i class="fa fa-circle"></i></a>
	...
	<div class="page-content">
		...
		<div class="content page-content-card page-content-card-bottom full-bottom">
			<h4 class="icon-heading uppercase ultrabold half-bottom">Square Thumbnails <i class="fa fa-camera"></i></h4>
			<p>
