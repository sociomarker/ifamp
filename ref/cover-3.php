	...
	<header>
			...
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item active-item" href="cover-3.php"><i class="fa fa-angle-right"></i><em></em>Cover Style 3<i class="fa fa-circle"></i></a>
		...
		<div class="cover-3">
			...
			<div class="socials">
				...
				<a href="#" class="icon-round phone-bg"><i class="fa fa-phone"></i></a>
