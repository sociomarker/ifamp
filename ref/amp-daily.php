		...
		<div id="menu-sidebar" class="menu menu-sidebar">
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						<a class="menu-item active-item" href="amp-daily.php"><i class="fa fa-angle-right"></i><em></em>AMP Daily Motion<i class="fa fa-circle"></i></a>
	...
	<div class="page-content">
		...
		<div class="tint-block tint-block-top bg-body-1">
			<div class="tint-content">
				...
				<h1 class="color-white uppercase">Daily Motion</h1>
				<span>
		...
		<div class="content page-content-card page-content-card-bottom full-bottom">
			<h4 class="icon-heading uppercase ultrabold half-bottom">Video Embed <i class="fa fa-bolt"></i></h4>
			<p>
				Embed videos with captions, in full width or boxed, with or without the branding icon. It's super easy.
			</p>
			<amp-dailymotion data-videoid="x2q4hjz" layout="responsive" data-ui-highlight="FF4081" width="480" height="270"></amp-dailymotion>
