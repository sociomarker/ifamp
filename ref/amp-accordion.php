...
<body class="dark-scheme">	
	<header>
		...
		<div id="menu-sidebar" class="menu menu-sidebar">
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					<input type="checkbox" data-submenu-items="7" class="toggle-submenu" id="toggle-11" checked>
					<label class="menu-item" for="toggle-11"><i class="fa fa-bolt"></i><span>AMP Features</span></label>
					<div class="submenu-wrapper">
						<a class="menu-item  active-item" href="amp-accordion.php"><i class="fa fa-angle-right"></i><em></em>AMP Accordion<i class="fa fa-circle"></i></a>
	...
	<div class="page-content">
		...
		<div class="tint-block tint-block-top-simple bg-body-1">
			<div class="tint-content">
				<h1 class="color-white uppercase">AMP</h1>
				<h1 class="color-white uppercase">Accordion</h1>
				<span>
		...
		<div class="content page-content-card-simple">
			<h4 class="icon-heading uppercase ultrabold half-bottom">Style 1 <i class="fa fa-bolt"></i></h4>
			<p>
				AMP accordions are extremely easy to use, they run just like a list. Embedding everything 
				with multiple sub-levels. Check it out!
			</p>
			<amp-accordion class="accordion full-bottom">
				<section>
					<h4>Accordion 1 <i class="fa fa-plus"></i></h4>
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam varius hendrerit libero, in bibendum nibh imperdiet porttitor. Cras enim enim, aliquet in est vel, auctor finibus nunc.</p>
				</section>
				<section>
					<h4>Accordion 2 <i class="fa fa-plus"></i></h4>
					<amp-accordion class="nested-accordion">
						<section>
							<h4>Nested Accordion 2.1</h4>
							<p>
								Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam varius hendrerit libero, 
								in bibendum nibh imperdiet porttitor. Cras enim enim, aliquet in est vel, auctor finibus nunc.
								<amp-img src="images/pictures/0w.jpg" width="300" height="150" layout="responsive"></amp-img>	
							</p>
						</section>
						<section>
							<h4>Nested Accordion Image 2.2</h4>
							<p>
								Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam varius hendrerit libero, 
								in bibendum nibh imperdiet porttitor. Cras enim enim, aliquet in est vel, auctor finibus nunc.
								<amp-img src="images/pictures/0w.jpg" width="300" height="150" layout="responsive"></amp-img>						
		...
		<div class="content page-content-card-simple">
			<h4 class="icon-heading uppercase ultrabold half-bottom">Style 2 <i class="fa fa-bolt"></i></h4>
			<p>
				AMP accordions are extremely easy to use, they run just like a list. Embedding everything 
				with multiple sub-levels. Check it out!
			</p>
			<amp-accordion class="accordion full-bottom">
				<section>
					<h4>Accordion 1 <i class="fa fa-angle-down"></i></h4>
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam varius hendrerit libero, in bibendum nibh imperdiet porttitor. Cras enim enim, aliquet in est vel, auctor finibus nunc.</p>
				</section>
				<section>
					<h4>Accordion 2 <i class="fa fa-angle-down"></i></h4>
					<amp-accordion class="nested-accordion">
						<section>
							<h4>Nested Accordion 2.1</h4>
							<p>
		...
		<div class="content page-content-card-simple">
			<h4 class="icon-heading uppercase ultrabold half-bottom">Style 3 <i class="fa fa-bolt"></i></h4>
			<p>
				AMP accordions are extremely easy to use, they run just like a list. Embedding everything 
				with multiple sub-levels. Check it out!
			</p>
			<amp-accordion class="accordion full-bottom">
				<section>
					<h4>Accordion 1 <i class="fa fa-chevron-down"></i></h4>
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam varius hendrerit libero, in bibendum nibh imperdiet porttitor. Cras enim enim, aliquet in est vel, auctor finibus nunc.</p>
				</section>
				<section>
					<h4>Accordion 2 <i class="fa fa-chevron-down"></i></h4>
					<amp-accordion class="nested-accordion">
						<section>
							<h4>Nested Accordion 2.1</h4>
							<p>
