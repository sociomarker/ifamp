		...
		<div id="menu-sidebar" class="menu menu-sidebar">
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						<a class="menu-item active-item" href="features-type.php"><i class="fa fa-angle-right"></i><em></em>Type<i class="fa fa-circle"></i></a>
	...
	<div class="page-content">
		...
		<div class="tint-block tint-block-top bg-body-1">
			<div class="tint-content">
				<h1 class="color-white uppercase">Typography</h1>
				<span>
					Esential features that make your style awesome.
				</span>
		...
		<div class="tint-block tint-block-content bg-body-1">
			<div class="tint-content">
				<h1 class="color-white uppercase">Icon</h1>
				<h1 class="color-white uppercase">Headings</h1>
				<span>
		...
		<div class="tint-block tint-block-content bg-body-1">
			<div class="tint-content">
				<h1 class="color-white uppercase">Dropcaps</h1>
				<span>
					If it's not broken don't fix it! Old school drop caps!
				</span>
				<div class="tint-items">
					<a href="#" class="tint-breadcrumb"><i class="fa fa-star"></i>More Features</a>
				</div>
		...
		<div class="content page-content-card page-content-card-bottom">
			...
			<p class="dropcaps-4">Dorem ipsum dolor sit amet, consectetur adipiscing elit. Donec varius dui et erat aliquet rutrum. Nunc vitae tincidunt magna. In vitae efficitur enim. Fusce a augue mi.</p>
		</div>		
				
		<div class="tint-block tint-block-content bg-body-1">
			<div class="tint-content">
				<h1 class="color-white uppercase">Highlights</h1>
				<span>
					Mark important text with style and elegant colors is simple.
				</span>
				<div class="tint-items">
					<a href="#" class="tint-breadcrumb"><i class="fa fa-star"></i>More Features</a>
				</div>
		...
		<div class="content page-content-card page-content-card-bottom">
			...
			<p class="highlight"><span class="bg-gray-dark">Highlight text</span> is really easy to use</p>
			<p class="highlight"><span class="bg-pink-dark">Highlight text</span> is really easy to use</p>
			<p class="highlight"><span class="bg-teal-dark">Highlight text</span> is really easy to use</p>
			<p class="highlight"><span class="bg-gray-light">Highlight text</span> is really easy to use</p>
		</div>	
		
		<div class="tint-block tint-block-content bg-body-1">
			<div class="tint-content">
				<h1 class="color-white uppercase">Lists</h1>
				<span>
					Simple lists, icon lists and much more.
				</span>
				<div class="tint-items">
					<a href="#" class="tint-breadcrumb"><i class="fa fa-star"></i>More Features</a>
				</div>
		...
		<div class="content page-content-card page-content-card-bottom full-bottom">
			...
			<div class="decoration"></div>
			<ul class="icon-list full-bottom">
