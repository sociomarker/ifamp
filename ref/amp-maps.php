			...
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item  active-item" href="amp-maps.php"><i class="fa fa-angle-right"></i><em></em>AMP Maps<i class="fa fa-circle"></i></a>
	...
	<div class="page-content">
		...
		<div class="tint-block tint-block-top-simple bg-body-1 full-bottom">
			<div class="tint-content">
				...
				<h1 class="color-white uppercase">MAPS</h1>
				<span>
		...
		<div class="content page-content-card full-bottom">
			<h5 class="uppercase ultrabold half-bottom">Using maps with AMP</h5>
			<p>
				As per Google AMP logic you can use maps only after 75% of the screen height of at least 600 pixels. So we wrote this text here
				to cover the required distance and also let you know that you can use this space for text, social media and other useful
				pieces of contact information.
			</p>
		</div>
		
		<amp-iframe class="full-bottom" width="600" height="600" layout="responsive" sandbox="allow-scripts allow-same-origin allow-popups" frameborder="0" src="https://www.google.com/maps/embed/v1/place?q=place_id:ChIJ2eUgeAK6j4ARbn5u_wAGqWA&key=AIzaSyCNCZ0Twm_HFRaZ5i-FuPDYs3rLwm4_848"></amp-iframe>
