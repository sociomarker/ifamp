			...
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item active-item" href="page-profile-2.php"><i class="fa fa-angle-right"></i><em></em>Profile 2<i class="fa fa-circle"></i></a>
		...
		<div class="page-content">
			<div class="page-content-scroll">
				...
				<div class="page-profile">
					<amp-img src="images/pictures/0.jpg" width="600" height="375" layout="responsive"></amp-img>
					<amp-img class="profile-thumb" src="images/pictures/1t.jpg" width="100" height="100"></amp-img>
					<div class="profile-header">
						<h1 class="center-text thin full-top half-bottom">John Doe</h1>
						<h6 class="center-text thiner uppercase">FRUIT SELLER</h6>
					...
					<div class="content full-bottom">
						<a href="#" class="button button-center button-round bg-pink-dark uppercase ultrabold">Follow John</a>
					</div>
