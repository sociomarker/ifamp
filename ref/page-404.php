...
<body class="dark-scheme">	
			...
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item active-item" href="page-404.php"><i class="fa fa-angle-right"></i><em></em>Error<i class="fa fa-circle"></i></a>
	...
	<div class="page-content">
		<div class="page-content-scroll">
			...
			<div class="page-404 full-bottom">
				<h1 class="center-text ultrabold">404</h1>
				<h6 class="center-text thiner full-bottom">Nothing to see here</h6>
				<p class="center-text boxed-text">
					It seems you've wondered too far into the woods. Try something else, maybe?
				</p>
				<a href="#" class="button button-center bold bg-green-dark">BACK HOME</a>
			</div>
