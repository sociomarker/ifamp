			...
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item  active-item" href="amp-lightbox.php"><i class="fa fa-angle-right"></i><em></em>AMP LightBox<i class="fa fa-circle"></i></a>
	...
	<div class="page-content">
		...
		<div class="tint-block tint-block-top-simple bg-body-1 full-bottom">
			<div class="tint-content">
				...
				<h1 class="color-white uppercase">LIGHTBOX</h1>
				<span>
		...
		<div class="content page-content-card full-bottom">
			<h4 class="icon-heading uppercase ultrabold half-bottom">Without Caption <i class="fa fa-bolt"></i></h4>
			<p>
		...
		<amp-img class="full-bottom" on="tap:lightbox1" role="button" tabindex="0" layout="responsive" src="images/pictures/4.jpg" width="300" height="180"></amp-img>
		
		<div class="content page-content-card-simple full-bottom">
			<h4 class="icon-heading uppercase ultrabold half-bottom">With Caption <i class="fa fa-bolt"></i></h4>
			<p>
				Powered by Google AMP and some awesoem code we made Google AMP as simple to edit
				as any other website and it's still 100% fully valid! This is awesome, right?
			</p>
		...
		<figure class="full-bottom">
			<amp-img on="tap:lightbox1" role="button" tabindex="0" layout="responsive" src="images/pictures/0.jpg" width="300" height="200"></amp-img>
			<figcaption class="hidden">Strawberries.</figcaption>
		</figure>	
