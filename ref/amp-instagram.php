			...
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item active-item" href="amp-instagram.php"><i class="fa fa-angle-right"></i><em></em>AMP Instagram<i class="fa fa-circle"></i></a>
	...
	<div class="page-content">
		...
		<div class="tint-block tint-block-top-simple bg-body-1 full-bottom">
			<div class="tint-content">
				...
				<h1 class="color-white uppercase">Instagram</h1>
				<span>
			...
			<div class="tint bg-magenta-dark"></div>
		</div>
		...
		<div class="content">
			...
			<a href="#" class="button-3d border-magenta-dark bg-magenta-light uppercase ultrabold button-full">Purchase Now</a>
		...
		<div class="tint-block tint-block-simple bg-body-1">
			...
			<div class="tint bg-magenta-light"></div>
		</div>
