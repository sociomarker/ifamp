	...
	<header>
		...
		<div id="menu-sidebar" class="menu menu-sidebar">
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					<input type="checkbox" data-submenu-items="8" class="toggle-submenu" id="toggle-4" checked>
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item active-item" href="page-timeline-2.php"><i class="fa fa-angle-right"></i><em></em>Timeline 2<i class="fa fa-circle"></i></a>
					</div>	
				</div>
				<div class="submenu-item">
			...
			<div class="page-content-scroll">
				...
				<div class="tint-block tint-block-top bg-body-1">
					<div class="tint-content">
						<h1 class="color-white uppercase">Timeline</h1>
						<span>
							Simple and elegant with multiple designs and styles.
						</span>
						<div class="tint-items">
							<a href="page-timeline-1.php" class="tint-breadcrumb"><i class="fa fa-list"></i>Version 1</a>
						</div>
					</div>
				...
				<div class="timeline-2">
					...
					<div class="container">
						<h4 class="center-text">Timeline</h4>
						<p class="center-text half-bottom">
							Timelines are awesome, easy to use, and simple to integrate. Just copy and paste.
						</p>
						<a href="#" class="button-3d button-center border-blue-dark bg-blue-light">Button</a>
					</div>	

					<div class="timeline-icon"><i class="fa fa-bolt"></i></div>		
					<div class="container">
						<h4 class="center-text half-bottom">AMP Powered</h4>
						<amp-img class="half-bottom" src="images/pictures/1ww.jpg" width="200" height="50" layout="responsive"></amp-img>
						<p class="center-text half-bottom">
							Amp is easy to use, and we made bullet proof and filled with custom features.
						</p>
					</div>

					<div class="timeline-icon"><i class="fa fa-quote-right"></i></div>		
					<div class="container">
						<div class="blockquote-3 full-bottom">
							...
							<a href="#" class="center-text full-bottom">Awesome Buyer | ThemeForest</a>
						</div>
					</div>		
					...
					<div class="container">
						...
						<a href="page-timeline-2.php" class="button-3d button-full border-blue-dark bg-blue-light">Check Version One</a>
					</div>
				</div>
