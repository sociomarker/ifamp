			...
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item  active-item" href="amp-carousel.php"><i class="fa fa-angle-right"></i><em></em>AMP Carousel<i class="fa fa-circle"></i></a>
	...
	<div class="page-content">
		...
		<div class="tint-block tint-block-top-simple bg-body-1 full-bottom">
			<div class="tint-content">
				...
				<h1 class="color-white uppercase">Carousel</h1>
				<span>
		...
		<div class="content">
			<h4 class="icon-heading uppercase ultrabold half-bottom">Simple Image Slider <i class="fa fa-bolt"></i></h4>
			<p>
				Image Sliders on AMP are awesome, they are preloaded, they run fast and are extremely easy to use.
			</p>
		</div>
		
		<amp-carousel height="300" width="400" layout="responsive" type="slides" autoplay loop delay="5000">
			<amp-img src="images/pictures/0.jpg" layout="responsive" width="320" height="280"></amp-img>
		...
		<div class="content">
			<h4 class="icon-heading uppercase ultrabold half-bottom">Caption Image Slider <i class="fa fa-bolt"></i></h4>
			<p>
				Image Sliders on AMP are awesome, they are preloaded, they run fast and are extremely easy to use.
			</p>
		</div>

		<amp-carousel class="slider half-bottom" width="600" height="375" layout="responsive" type="slides" controls autoplay loop delay="3000">
			<div>
