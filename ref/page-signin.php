...
<body class="dark-scheme">	
	<header>
		...
		<div id="menu-sidebar" class="menu menu-sidebar">
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						<a class="menu-item active-item" href="page-signin.php"><i class="fa fa-angle-right"></i><em></em>Sign In<i class="fa fa-circle"></i></a>
		...
		<div class="splash-login">
			<a href="index.php" class="splash-logo"></a>
			<h6 class="color-gray-dark thin center-text half-bottom">Fast, simple, efficient</h6>

			<div class="splash-input full-bottom">
			...
			<a href="#" class="small-text color-gray-dark center-text">Forgot your password?</a>
			<a href="#" class="button button-full bg-green-dark uppercase bold">LOGIN</a>
			<a href="page-signup.php" class="small-text color-gray-dark center-text">Don't have an account? Register here.</a>
		</div>	
