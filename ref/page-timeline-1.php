			...
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item active-item" href="page-timeline-1.php"><i class="fa fa-angle-right"></i><em></em>Timeline 1<i class="fa fa-circle"></i></a>
			...
			<div class="page-content-scroll">
				...
				<div class="tint-block tint-block-top bg-body-1 ">
					<div class="tint-content">
						...
						<div class="tint-items">
							<a href="page-timeline-2.php" class="tint-breadcrumb"><i class="fa fa-list"></i>Version 2</a>
						</div>
					</div>
				...
				<div class="timeline-1">
					...
					<div class="container">
						...
						<a href="#" class="button-3d button-center border-red-dark bg-red-light">Button</a>
					</div>	
					...
					<div class="container">
						...
						<a href="page-timeline-2.php" class="button-3d button-full border-red-dark bg-red-light">Check Version Two</a>
					</div>
				</div>
