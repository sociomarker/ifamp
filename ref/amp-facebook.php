	...
	<header>
		...
		<div id="menu-sidebar" class="menu menu-sidebar">
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					<input type="checkbox" data-submenu-items="5" class="toggle-submenu" id="toggle-10" checked>
					<label class="menu-item" for="toggle-10"><i class="fa fa-bolt"></i><span>AMP Social</span></label>
					<div class="submenu-wrapper">
						<a class="menu-item active-item" href="amp-facebook.php"><i class="fa fa-angle-right"></i><em></em>AMP Facebook<i class="fa fa-circle"></i></a>
	...
	<div class="page-content">
		...
		<div class="tint-block tint-block-top-simple bg-body-1 full-bottom">
			<div class="tint-content">
				...
				<h1 class="color-white uppercase">Facebook</h1>
				<span>
			...
			<div class="tint bg-blue-dark"></div>
		</div>
		
		<div class="content">
			<h4 class="icon-heading uppercase ultrabold half-bottom">Post Embed <i class="fa fa-bolt"></i></h4>
			<p>
				Embed videos with captions, in full width or boxed, with or without the branding icon. It's super easy.
			</p>
		</div>
		
		<amp-facebook class="half-bottom" width="552" height="303" layout="responsive" data-href="https://www.facebook.com/enabled.labs/posts/1395483060466743"></amp-facebook>

		<div class="decoration decoration-margins"></div>
		
		<amp-facebook class="half-bottom" width="552" height="303" layout="responsive" data-href="https://www.facebook.com/enabled.labs/posts/1338259389522444"></amp-facebook>
		
		<div class="decoration decoration-margins"></div>
		
		<amp-facebook class="half-bottom" width="300" height="303" layout="responsive" data-href="https://www.facebook.com/envato/videos/10154016944881209/"></amp-facebook>
