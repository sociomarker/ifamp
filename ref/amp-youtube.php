			...
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item active-item" href="amp-youtube.php"><i class="fa fa-angle-right"></i><em></em>AMP Youtube<i class="fa fa-circle"></i></a>
					</div>	
				</div>		
				<div class="submenu-item">
	...
	<div class="page-content">
		...
		<div class="tint-block tint-block-top bg-body-1">
			<div class="tint-content">
				...
				<h1 class="color-white uppercase">YouTube</h1>
				<span>
		...
		<div class="content page-content-card page-content-card-bottom full-bottom">
			...
			<amp-youtube width="480" height="270" layout=responsive data-videoid="c9MnSeYYtYY"></amp-youtube>	
