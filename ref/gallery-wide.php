	...
	<header>
		...
		<div id="menu-sidebar" class="menu menu-sidebar">
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					<input type="checkbox" data-submenu-items="3" class="toggle-submenu" id="toggle-5" checked>
					...
					<div class="submenu-wrapper">
						...
						<a class="active-item menu-item" href="gallery-wide.php"><i class="fa fa-angle-right"></i><em></em>Wide<i class="fa fa-circle"></i></a>
					</div>	
				</div>
				<div class="submenu-item">
	...
	<div class="page-content">
		...
		<div class="tint-block tint-block-top bg-body-1">
			<div class="tint-content">
				<h1 class="color-white uppercase">Gallery</h1>
				<span>
		...
		<div class="content page-content-card page-content-card-bottom full-bottom">
			<h4 class="icon-heading uppercase ultrabold half-bottom">Wide Images <i class="fa fa-camera"></i></h4>
			<p>
				Extremly simple to use, automatically floated and preloaded. Automatically preloaded by AMP.
			</p>
		</div>		
			
		<amp-image-lightbox id="lightbox1"layout="nodisplay"></amp-image-lightbox>
		<div class="gallery-wide full-bottom">
			<amp-img class="gallery-thumb-wide" on="tap:lightbox1" role="button" tabindex="0" layout="responsive" src="images/pictures/0.jpg" width="600" height="375"></amp-img>
			<h4>Strawberries</h4>
