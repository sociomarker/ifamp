...
<body class="dark-scheme">	
			...
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item active-item" href="index-splash.php"><i class="fa fa-angle-right"></i><em></em>Splash<i class="fa fa-circle"></i></a>
	...
	<div class="splash-content">
		...
		<p class="center-text color-gray-light">
			Google AMP aims to simplify the way you use the internet. The biggest trend on the market!
			All aboard!
		</p>
		<a href="#" class="splash-button bg-green-dark uppercase ultrabold">Welcome</a>
	</div>	
