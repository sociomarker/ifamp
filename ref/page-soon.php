...
<body class="dark-scheme">	
			...
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item active-item" href="page-soon.php"><i class="fa fa-angle-right"></i><em></em>Soon<i class="fa fa-circle"></i></a>
	...
	<div class="page-content">
		<div class="page-content-scroll">
			...
			<div class="page-soon full-bottom">
				<h1 class="center-text ultrabold half-bottom"><i class="fa fa-spin fa-cog color-black"></i></h1>
				<h6 class="center-text ultrabold uppercase quarter-bottom">Coming Soon</h6>
				<p class="center-text boxed-text">
					We'll have this page up and running in no time! Follow or socials for updates!
				</p>
				<div class="social-icons">
					<a href="#" class="color-white icon-round facebook-bg center-text"><i class="fa fa-facebook"></i></a>
					<a href="#" class="color-white icon-round google-bg center-text"><i class="fa fa-google-plus"></i></a>
					<a href="#" class="color-white icon-round twitter-bg center-text"><i class="fa fa-twitter"></i></a>
					<div class="clear"></div>
				</div>
			</div>
