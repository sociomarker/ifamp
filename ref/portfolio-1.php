		...
		<div id="menu-sidebar" class="menu menu-sidebar">
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						<a class="active-item menu-item" href="portfolio-1.php"><i class="fa fa-angle-right"></i><em></em>One Item<i class="fa fa-circle"></i></a>
	...
	<div class="page-content">
		...
		<div class="tint-block tint-block-top bg-body-1">
			<div class="tint-content">
				...
				<h1 class="color-white uppercase">One Column</h1>
				<span>
		...
		<div class="content page-content-card page-content-card-bottom full-bottom">
			<div class="portfolio-item">
				...
				<h3 class="uppercase ultrabold half-top half-bottom">Project Title</h3>
				<p>
			...
			<div class="decoration"></div>
			<div class="portfolio-item">
				<amp-img src="images/pictures/2.jpg" layout="responsive" width="600" height="375"></amp-img>
				<h3 class="uppercase ultrabold half-top half-bottom">Project Title</h3>
				<p>
					Suspendisse interdum, est a maximus imperdiet, dolor ipsum consequat purus, 
					vitae posuere dui lectus id erat. Nulla sed suscipit lorem. Praesent ultricies eget.
