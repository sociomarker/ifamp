	...
	<header>
		...
		<div id="menu-sidebar" class="menu menu-sidebar">
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					<input type="checkbox" data-submenu-items="3" class="toggle-submenu" id="toggle-6" checked>
					...
					<div class="submenu-wrapper">
						...
						<a class="active-item menu-item" href="portfolio-2.php"><i class="fa fa-angle-right"></i><em></em>Two Item<i class="fa fa-circle"></i></a>
	...
	<div class="page-content">
		...
		<div class="tint-block tint-block-top bg-body-1">
			<div class="tint-content">
				<h1 class="color-white uppercase">Portfolio</h1>
				<h1 class="color-white uppercase">Two Columns</h1>
				<span>
		...
		<div class="content page-content-card page-content-card-bottom full-bottom">
			<div class="left-column">
				<div class="portfolio-item">
					<amp-img src="images/pictures/0.jpg" layout="responsive" width="600" height="375"></amp-img>
					<h4 class="ultrabold uppercase half-top">Project 1</h4>
					<p class="small-text">
						Suspendisse interdum, est a maximus imperd, dolor ipsum consequat purus, 
						vitae posuere dui lectus id erat. 
					</p>
					<a href="#" class="right-text full-bottom">Read More</a>
				</div>
			</div>
			<div class="right-column">
				<div class="portfolio-item">
					<amp-img src="images/pictures/1.jpg" layout="responsive" width="600" height="375"></amp-img>
					<h4 class="ultrabold uppercase half-top">Project 2</h4>
					<p class="small-text">
						Suspendisse interdum, est a maximus imperd, dolor ipsum consequat purus, 
						vitae posuere dui lectus id erat. 
					</p>
			...
			<div class="left-column">
				<div class="portfolio-item">
					<amp-img src="images/pictures/3.jpg" layout="responsive" width="600" height="375"></amp-img>
					<h4 class="ultrabold uppercase half-top">Project 3</h4>
					<p class="small-text">
						Suspendisse interdum, est a maximus imperd, dolor ipsum consequat purus, 
						vitae posuere dui lectus id erat. 
					</p>
			...
			<div class="right-column">
				<div class="portfolio-item">
					<amp-img src="images/pictures/4.jpg" layout="responsive" width="600" height="375"></amp-img>
					<h4 class="ultrabold uppercase half-top">Project 4</h4>
					<p class="small-text">
						Suspendisse interdum, est a maximus imperd, dolor ipsum consequat purus, 
						vitae posuere dui lectus id erat. 
					</p>
		...
		<div class="decoration decoration-margins full-bottom full-top"></div>
