...
<body class="dark-scheme bg-body">	
	<header>
		...
		<div id="menu-sidebar" class="menu menu-sidebar">
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					<input type="checkbox" data-submenu-items="5" class="toggle-submenu" id="toggle-3" checked>
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item active-item" href="cover-4.php"><i class="fa fa-angle-right"></i><em></em>Cover Style 4<i class="fa fa-circle"></i></a>
		...
		<div class="cover-4">
			<h1>Jane Doe</h1>
			<em>Google AMP Developer</em>
			<strong><i class="fa fa-map-marker"></i>USA, California</strong>
			<p>
				Dedicated and energetic Developer with years of experience in custom and specialized coding techniques.
			</p>
			<a href="contact.html" class="button button-round button-center bg-blue-dark uppercase bold">Schedule a Meeting</a>

			<div class="cover-socials">
				<a href="#" class="facebook-bg"><i class="fa fa-facebook"></i></a>
				<a href="#" class="twitter-bg"><i class="fa fa-twitter"></i></a>
				<a href="#" class="google-bg"><i class="fa fa-google-plus"></i></a>
				<a href="#" class="phone-bg"><i class="fa fa-phone"></i></a>
				<a href="#" class="mail-bg"><i class="fa fa-envelope"></i></a>
			</div>
		</div>
