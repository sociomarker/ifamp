...
<body class="dark-scheme">	
		...
		<div id="menu-sidebar" class="menu menu-sidebar">
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						<a class="active-item menu-item" href="gallery-round.php"><i class="fa fa-angle-right"></i><em></em>Round<i class="fa fa-circle"></i></a>
	...
	<div class="page-content">
		...
		<div class="content page-content-card page-content-card-bottom full-bottom">
			<h4 class="icon-heading uppercase ultrabold half-bottom">Round Thumbnails <i class="fa fa-camera"></i></h4>
			<p>
