...
<body class="dark-scheme">	
		...
		<div id="menu-sidebar" class="menu menu-sidebar">
			<div class="menu-scroll">	
				<div class="sidebar-socials">
					...
					<a href="https://plus.google.com/u/1/105775801838187143320"><i class="fa fa-google-plus"></i></a>
				...
				<em class="sidebar-logo-text">The full power of Google AMP</em>
				<a class="menu-item active-item" href="index.php"><i class="fa fa-star"></i><em></em><strong></strong><span>Welcome</span><i class="fa fa-circle"></i></a>	
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						<a class="menu-item" href="index-classic.php"><i class="fa fa-angle-right"></i>Classic<i class="fa fa-circle"></i></a>
						<a class="menu-item" href="index-splash.php"><i class="fa fa-angle-right"></i>Splash<i class="fa fa-circle"></i></a>
						<a class="menu-item" href="index-login.php"><i class="fa fa-angle-right"></i>Login<i class="fa fa-circle"></i></a>
						<a class="menu-item" href="index-landing.php"><i class="fa fa-angle-right"></i>Landing<i class="fa fa-circle"></i></a>
					</div>	
				</div>		
				<div class="submenu-item">
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						<a class="menu-item" href="page-signin.php"><i class="fa fa-angle-right"></i>Sign In<i class="fa fa-circle"></i></a>
						<a class="menu-item" href="page-signup.php"><i class="fa fa-angle-right"></i>Sign Up<i class="fa fa-circle"></i></a>
						<a class="menu-item" href="page-404.php"><i class="fa fa-angle-right"></i>Error<i class="fa fa-circle"></i></a>
	...
	<div class="page-content">
		...
		<div class="content page-content-card page-content-card-bottom">
			<h4 class="icon-heading uppercase ultrabold half-bottom">Meet Cards AMP <i class="fa fa-bolt"></i></h4>
			<p>
				Powered by Google AMP and some awesoem code we made Google AMP as simple to edit
				as any other website and it's still 100% fully valid! This is awesome, right?
			</p>
			<amp-img src="images/pictures/0w.jpg" width="600" height="250" layout="responsive" class="full-bottom"></amp-img>
			<p>
			...
			<a href="#" class="button-3d border-blue-dark bg-blue-light uppercase ultrabold button-full">Purchase Now</a>
			<div class="full-bottom"></div>
		</div>		
			
		<div class="tint-block tint-block-content bg-4">
			<div class="tint-content">
				<h1 class="color-white uppercase">Powerful</h1>
				<h3 class="color-white ultrabold uppercase">Simple Features</h3>
				<span>
					AMP is incredibly powerful and easy to use if it's built by the experts.
				</span>
				<div class="tint-items">
					<a href="#" class="tint-breadcrumb"><i class="fa fa-cog"></i>More Features</a>
				</div>
			</div>
			<div class="tint bg-blue-light"></div>
		</div>
		
		<div class="content page-content-card">
			<h5 class="icon-heading uppercase ultrabold half-bottom">Any feature, mobile. <i class="fa fa-cog"></i></h5>
			<p>
				Features designed to be eye candy, just waitng to be touched, with crisp, clear typography
				and amazingly elegant contrasting colors to attract any eye.
			</p>
			<div class="decoration"></div>
			
			<div class="icon-column">
				<h4 class="center-text">
					<i class="fa fa-cog bg-blue-light color-white"></i>
			...
			<div class="icon-column">
				<h4 class="center-text">
					<i class="fa fa-user bg-teal-light color-white"></i>
					User friendly, easy to edit
				</h4>
				<p class="center-text">
					We know our users need simplicity for them to be able to easily edit and launch their products efficiently without headaches.
				</p>
			...
			<div class="icon-column">
				<h4 class="center-text">
					<i class="bg-red-light color-white fa fa-star"></i>
					Envato Elite. Nieche Leader
				</h4>
				<p class="center-text">
			...
			<div class="icon-column">
				<h4 class="center-text">
					<i class="fa fa-leaf bg-green-light"></i>
					Enviourmentaly Friendly
				</h4>
				<p class="center-text">
			...
			<div class="decoration"></div>
			<a href="#" class="button-3d border-green-dark bg-green-light uppercase ultrabold button-full">MORE FEATURES</a>
			<div class="full-bottom"></div>
		</div>
		
		<div class="tint-block tint-block-content bg-5">
			<div class="tint-content">
				<h1 class="color-white uppercase">MEDIA</h1>
				<span>
					AMP thumbnail image galleries and Lightbox, designed to look and feel native.
				</span>
				<div class="tint-items">
					<a href="#" class="tint-breadcrumb"><i class="fa fa-image"></i>More Media</a>
				</div>
			</div>
			<div class="tint bg-green-light"></div>
		</div>
		
		<div class="content page-content-card">
			<h5 class="icon-heading uppercase ultrabold half-bottom">Image Gallery <i class="fa fa-camera"></i></h5>
			<p>
				Tap and enjoy, change the image, save it, scale it, enjoy! Everything is ready preloaded by AMP
			</p>
			<div class="decoration"></div>
			...
			<div class="decoration"></div>
			<a href="#" class="button-3d border-pink-dark bg-pink-light uppercase ultrabold button-full">CHECK THE GALLERY</a>
			<div class="full-bottom"></div>
		</div>
		
		<div class="tint-block tint-block-content bg-5">
			<div class="tint-content">
				<h1 class="color-white uppercase">HAPPY</h1>
				<h1 class="color-white uppercase">CUSTOMERS</h1>
				<span>
					Our customers always leave us the best and most amazing feedback, we love to share.
				</span>
				<div class="tint-items">
					<a href="#" class="tint-breadcrumb"><i class="fa fa-quote-right"></i>Quotes & Reviews</a>
				</div>
			</div>
			<div class="tint bg-pink-light"></div>
		</div>
		
		<div class="content page-content-card full-bottom">
			<h5 class="icon-heading uppercase ultrabold half-bottom">Customer Feedback <i class="fa fa-star"></i></h5>
			<p>
				Blockquotes and quotes, designed to look and feel amazing and to get a reaction from your users.
			</p>
			<div class="decoration"></div>
			
			<div class="blockquote-2 full-bottom">
				<amp-img class="blockquote-image" src="images/pictures/1t.jpg" width="50" height="50"></amp-img>
				<h5 class="italic">" Simply Incredible "</h5>
				<i class="first-icon half-bottom color-yellow-dark fa fa-star"></i>
				<i class="color-yellow-dark fa fa-star"></i>
				<i class="color-yellow-dark fa fa-star"></i>
				<i class="color-yellow-dark fa fa-star"></i>
				<i class="color-yellow-dark fa fa-star"></i>
				<p class="italic">
					The template is beautify, easy to use, and very well documented, but he best has been the customer support. Prompt, helpful replies.
				</p>
				<a href="#">Alexander Stranger | ThemeForest Buyer</a>
			</div>
			
			<div class="decoration"></div>
			
			<div class="blockquote-2 full-bottom">
				<amp-img class="blockquote-image" src="images/pictures/2t.jpg" width="50" height="50"></amp-img>
				<h5 class="italic">" A Pleasure to Use "</h5>
				<i class="first-icon half-bottom color-yellow-dark fa fa-star"></i>
				<i class="color-yellow-dark fa fa-star"></i>
				<i class="color-yellow-dark fa fa-star"></i>
				<i class="color-yellow-dark fa fa-star"></i>
				...
				<a href="#">John Doe | CodeCanyon Buyer</a>
			</div>
			
			<div class="decoration"></div>
			
			<div class="blockquote-2 full-bottom">
				<amp-img class="blockquote-image" src="images/pictures/3t.jpg" width="50" height="50"></amp-img>
				<h5 class="italic">" Awesome Support "</h5>
				<i class="first-icon half-bottom color-yellow-dark fa fa-star"></i>
				<i class="color-yellow-dark fa fa-star"></i>
				<i class="color-yellow-dark fa fa-star"></i>
				<i class="color-yellow-dark fa fa-star"></i>
				...
				<a href="#">Vera Linn | CodeCanyon Buyer</a>
			</div>
			
			<div class="decoration"></div>
			<a href="#" class="button-3d border-blue-dark bg-blue-light uppercase ultrabold button-full">READ MORE</a>
			<div class="full-bottom"></div>
			<div class="decoration"></div>
			
			<h1 class="center-text uppercase ultrabold">Much More</h1>
			<h6 class="center-text uppercase ultrabold full-bottom">We have tons to show you</h6>
			...
			<div class="left-column">
				<ul class="icon-list">
					...
					<li><i class="fa fa-exclamation"></i>Error Page</li>
					<li><i class="fa fa-clock-o"></i>Soon Page</li>
					<li><i class="fa fa-file-o"></i>Cover Page</li>
					<li><i class="fa fa-lock"></i>Login Page</li>
					<li><i class="fa fa-bolt"></i>AMP Pages</li>
				</ul>
			</div>
			<div class="right-column">
				<ul class="icon-list">
					<li><i class="fa fa-power-off"></i>Buttons</li>
					<li><i class="fa fa-share-alt"></i>Share Icons</li>
					<li><i class="fa fa-youtube-play"></i>Video Page</li>
					<li><i class="fa fa-envelope-o"></i>Contact Page</li>
					<li><i class="fa fa-picture-o"></i>Folio Pages</li>
					<li><i class="fa fa-camera"></i>Gallery Page</li>
					<li><i class="fa fa-lock full-bottom"></i>Signup Page</li>
				</ul>
			</div>
			<div class="clear"></div>
			<div class="decoration"></div>
			<h2 class="center-text uppercase ultrabold">A AMP Experience</h2>
			<h6 class="center-text uppercase ultrabold full-bottom">Speed, Design, Features</h6>
			<p class="italic center-text">
				Every feature you need to completly make your mobile site a power horse,
				combined with unmatched speed! 
			</p>
			<a href="#" class="button-3d border-red-dark bg-red-light color-white uppercase ultrabold button-full full-bottom">Purchase Now</a>
			<div class="full-bottom"></div>
		</div>
		
		<div class="tint-block tint-block-simple bg-body-1">
			<div class="tint-content">
				<h1 class="color-white uppercase">AMP</h1>
				<h1 class="color-white uppercase">Cards</h1>
				<span>
					A truly incredible mobile experience. Get it today!
				</span>
				<div class="tint-items">
					<a href="#" class="tint-breadcrumb"><i class="fa fa-dollar"></i>Purchase Today</a>
				</div>
			</div>
			<div class="tint bg-red-light"></div>
		</div>
		...
		<div class="footer">
			...
			<div class="footer-socials">
				...
				<a href="https://twitter.com/iEnabled"><i class="fa fa-twitter"></i></a>
				<a href="tel:+1-234-567-8901"><i class="fa fa-phone"></i></a>
				<a href="mailto:name@domain.com"><i class="fa fa-envelope"></i></a>
				<a href="#"><i class="fa fa-angle-up"></i></a>
				<div class="clear"></div>
			</div>
			<div class="decoration-light decoration-margins"></div>
			<p class="center-text no-bottom">Copyright Enabled. All rights reserved.</p>
		</div>			
	</div>
