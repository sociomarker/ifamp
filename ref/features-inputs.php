			...
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item active-item" href="features-inputs.php"><i class="fa fa-angle-right"></i><em></em>Inputs<i class="fa fa-circle"></i></a>
	...
	<div class="page-content">
		...
		<div class="tint-block tint-block-top bg-body-1">
			<div class="tint-content">
				<h1 class="color-white uppercase">Inputs</h1>
				<span>
			...
			<div class="tint bg-teal-dark"></div>
		</div>
		
		<div class="content page-content-card page-content-card-bottom full-bottom">
			<p>
				Text fields icons and select boxes. You can use any input that is AMP compatible.
			</p>
			
			<input class="text-input full-bottom" type="text" placeholder="Simple text input box...">
			
			<div class="input-icon full-bottom">
				<i class="fa fa-search"></i>
				<input class="input-icon-field" type="text" placeholder="Input box with icon...">
			</div>		
			...
			<div class="input-icon full-bottom">
				...
				<input class="input-icon-field" type="text" placeholder="Password Field">
			</div>
			
			<div class="select-style full-bottom">
				<select>
					<option value="volvo">Select Box</option>
					<option value="saab">Apple</option>
