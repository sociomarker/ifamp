...
<body class="dark-scheme">	
			...
			<div class="menu-scroll">	
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="active-item menu-item" href="portfolio-item.php"><i class="fa fa-angle-right"></i><em></em>Selected Item<i class="fa fa-circle"></i></a>
					</div>	
				</div>
	...
	<div class="page-content">
		...
		<div class="content page-content-card-simple full-bottom">
			...
			<amp-img class="full-bottom" src="images/pictures/4.jpg" width="600" height="350" layout="responsive"></amp-img>
			...
			<amp-img class="full-bottom" src="images/pictures/0ww.jpg" width="600" height="150" layout="responsive"></amp-img>
