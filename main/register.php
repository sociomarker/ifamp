	...
	<header>
		...
		<div id="menu-sidebar" class="menu menu-sidebar">
			<div class="menu-scroll">	
				...
				<em class="sidebar-logo-text">Connecting India's Fastener Industry<br /> to the world</em>
				...
				<div class="submenu-item">
					...
					<div class="submenu-wrapper">
						...
						<a class="menu-item active-item" href="page-signup.php"><i class="fa fa-angle-right"></i><em></em>Sign Up<i class="fa fa-circle"></i></a>
		...
		<div class="splash-signup">
			...
			<h6 class="splash-text color-gray-dark thin center-text half-bottom">Fast, simple, efficient</h6>
			...
			<a href="page-signup.php" class="small-text color-gray-dark center-text">Already registered? Sign In Here.</a>
		</div>	
